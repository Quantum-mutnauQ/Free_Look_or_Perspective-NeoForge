...
public class FreeLookKey {
    ...
    public static final KeyMapping FREELOOK_KAY = new KeyMapping(KEY_FREE_LOOK,InputConstants.KEY_F6,KEY_CATEGORY_FREELOOK);
    public static final KeyMapping PERSPECTIVESWAP_KAY = new KeyMapping(KEY_PERSPECTIVE_SWAP, InputConstants.KEY_F7,KEY_CATEGORY_FREELOOK);
