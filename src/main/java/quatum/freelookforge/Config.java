...
public class Config
{
    ...
    private static final ForgeConfigSpec.EnumValue AutoSwitchPerspective = BUILDER.comment("Automatik switches perspective wenn free look trigger")
            .defineEnum("AutoSwitchPerspective",SwitchPerspective.OFF);
    private static final ForgeConfigSpec.BooleanValue AutoSwitchPerspeciveBack = BUILDER.comment("Automatik switches perspective back wenn free look trigger stops")
